...
class GPTdata(SQLiteDatabase):
    ...
    def create_gpt_latency_data(self):
        # drop_sql = "drop table gpt_latency_data"
        # self.modify(drop_sql)
    ...
    def create_gpt_latency_data_history(self):
        # drop_sql = "drop table gpt_latency_data_history"
        # self.modify(drop_sql)
        create_sql = """CREATE TABLE IF NOT EXISTS gpt_latency_data_history (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
                region TEXT NOT NULL,
                resource_name TEXT NOT NULL,
                deployment_name TEXT NOT NULL,
                ...
                create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
                update_time DATETIME DEFAULT CURRENT_TIMESTAMP,
                unique(region, model_name, deployment_type, model_version, type, request_times, create_time)
                );"""
        self.modify(create_sql)
        print("gpt_latency_data_history table created.")
...
def main(): 
    ...
    try:  
        ...
        sql_db.create_gpt_latency_data()
        sql_db.create_gpt_latency_data_history()
    except Exception as e:  
        print(f"Err: {e}")  
        traceback.print_exc()
